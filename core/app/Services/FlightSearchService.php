...
{
    return [
        'provider_a' => $this->fetchMockData('provider_a'),
        'provider_b' => $this->fetchMockData('provider_b'),
        'provider_c' => $this->fetchMockData('provider_c'),
    ];
}
    ...
    private function fetchMockData(string $provider): array
{
    $rootKey = [
        'provider_a' => 'flights',
        'provider_b' => 'data',
    ...
    $data = json_decode($this->mockJson($provider), true);
...
private function mockJson(string $provider): string
{
